...
import model.tb_password_J;

public class Password_db {
    private DBOpenHelper helper;// 创建DBOpenHelper对象
    private SQLiteDatabase db;// 创建SQLiteDatabase对象

    public Password_db(Context context){// 定义构造函数
     ...
     * @param tb_pwd
     */
    public void add(tb_password_J tb_pwd) {
        // 执行添加密码操作
     ...
     * @param tb_pwd
     */
    public void update(tb_password_J tb_pwd) {
//		db = helper.getWritableDatabase();// 初始化SQLiteDatabase对象
        // 执行修改密码操作
